...
from soulless_learning.ppo.lib import common, ppo
from soulless_learning.ppo.lib import wrappers
...
if __name__ == "__main__":
    ...
    test_env = wrappers.wrap_dqn(make(params.env_name))
    ...
    common.setup_ignite(engine, params, exp_source, NAME + "_" + args.name, net, optimizer, extra_metrics=(
    ...
    def test_network(engine):
        ...
        if test_reward_avg > params.stop_test_reward:
            print("Reward boundary has crossed, stopping training. Congrats!")
    ...
    if do_distill:
        engine.run(ppo.batch_generator_distill(exp_source, net, params.ppo_trajectory,
                                               ...
                                               trim_trajectory=False, new_batch_callable=new_ppo_batch), max_epochs=10000, epoch_length=1000)
    else:
